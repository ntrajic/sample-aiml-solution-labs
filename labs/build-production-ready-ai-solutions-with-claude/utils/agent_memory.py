...
def delete_memory(memory_hook):
    try:
        ...
        ssm_client.delete_parameter(Name="/app/returnsrefunds/agentcore/memory_id")
    except Exception:
        pass


class ReturnsRefundsMemoryHooks(HookProvider):
    """Memory hooks for returns and refunds agent"""
...
def get_memory_hooks():
    ...
    memory_hooks = ReturnsRefundsMemoryHooks(
