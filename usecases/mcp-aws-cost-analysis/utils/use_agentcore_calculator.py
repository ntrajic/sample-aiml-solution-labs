...
def use_agentcore_calculator(params: dict) -> dict:
    ...
    try:
        ...
        return {'error': f'Invalid global parameters: {str(e)}'}
    ...
    if 'runtime' in params:
        try:
            ...
            if cost_per_vcpu_hour is None:
                return {'error': 'Runtime component missing required parameter: cost_per_vcpu_hour'}
            if cost_per_gb_hour is None:
                return {'error': 'Runtime component missing required parameter: cost_per_gb_hour'}
            ...
            return {'error': f'Error calculating runtime costs: {str(e)}'}
    ...
    if 'browser' in params:
        try:
            ...
            if cost_per_vcpu_hour is None:
                return {'error': 'Browser component missing required parameter: cost_per_vcpu_hour'}
            if cost_per_gb_hour is None:
                return {'error': 'Browser component missing required parameter: cost_per_gb_hour'}
            ...
            return {'error': f'Error calculating browser costs: {str(e)}'}
    ...
    if 'code_interpreter' in params:
        try:
            ...
            if cost_per_vcpu_hour is None:
                return {'error': 'Code interpreter component missing required parameter: cost_per_vcpu_hour'}
            if cost_per_gb_hour is None:
                return {'error': 'Code interpreter component missing required parameter: cost_per_gb_hour'}
            ...
            return {'error': f'Error calculating code interpreter costs: {str(e)}'}
    ...
    if 'gateway' in params:
        try:
            ...
            if cost_per_invoke_tool_api is None:
                return {'error': 'Gateway component missing required parameter: cost_per_invoke_tool_api'}
            if cost_per_search_api_invocation is None:
                return {'error': 'Gateway component missing required parameter: cost_per_search_api_invocation'}
            if cost_per_tool_indexed_per_month is None:
                return {'error': 'Gateway component missing required parameter: cost_per_tool_indexed_per_month'}
            ...
            return {'error': f'Error calculating gateway costs: {str(e)}'}
    ...
    if 'memory' in params:
        try:
            ...
            if cost_per_raw_event is None:
                return {'error': 'Memory component missing required parameter: cost_per_raw_event'}
            if cost_per_memory_record_per_month is None:
                return {'error': 'Memory component missing required parameter: cost_per_memory_record_per_month'}
            if cost_per_memory_retrieval is None:
                return {'error': 'Memory component missing required parameter: cost_per_memory_retrieval'}
            ...
            return {'error': f'Error calculating memory costs: {str(e)}'}
    ...
    try:
        ...
        return {'error': f'Error calculating total costs: {str(e)}'}
