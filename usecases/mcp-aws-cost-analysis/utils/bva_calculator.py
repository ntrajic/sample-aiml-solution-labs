...
def bva_calculator(params: dict) -> dict:
    ...
    if ai_agent_cost_per_month is None:
        return {'error': 'Missing required global parameter: ai_agent_cost_per_month'}
    ...
    if 'cost_savings' in params:
        try:
            ...
            return {'error': f'Error calculating cost savings: {str(e)}'}
    ...
    if 'revenue_growth' in params:
        try:
            ...
            return {'error': f'Error calculating revenue growth: {str(e)}'}
    ...
    if 'customer_churn_reduction' in params:
        try:
            ...
            if total_customer_count is None:
                return {'error': 'Customer churn reduction component missing required parameter: total_customer_count'}
            ...
            return {'error': f'Error calculating customer churn reduction: {str(e)}'}
    ...
    if 'implementation_costs' in params:
        try:
            ...
            return {'error': f'Error calculating implementation costs: {str(e)}'}
    ...
    try:
        ...
        return {'error': f'Error calculating business value summary: {str(e)}'}
